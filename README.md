...
The data directory contains all supplementary tables (Tables S1-S5).  
The plots directory contains high quality PDF plot files (Figures 1-4 and all the Supplementary Figures).  
